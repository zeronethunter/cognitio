...
#ifndef CGNT_CORE_COMMANDS_COMMAND_REPO_HPP_
#define CGNT_CORE_COMMANDS_COMMAND_REPO_HPP_
...
class RepoMeta : public CmdMeta {
 public:
  RepoMeta() : CmdMeta(std::string("repo")) {}
};

class RepoCmd : public Command<Context> {
 public:
  RepoCmd() : Command(RepoMeta()){};
...
#endif  // CGNT_CORE_COMMANDS_COMMAND_REPO_HPP_
